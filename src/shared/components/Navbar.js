       ...
       const navClass = this.state.collapsed ? "collapse" : "";
         return(
           <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <Link class="navbar-brand" to={{pathname:"/",state:{referrer:"brand"}}}  style={{transform: "translateY(7px)"}}>Chu-Ya Chia<br/><span style={{fontSize:"50%",textShadow:"0 0 2px #fff",color:"#919aa1"}}>Available for hire</span></Link>
